...
export default function Header({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl bg-slate-100 p-4">
      <h2 className="flex-shrink-0 font-semibold text-zinc-600">Grupe:</h2>
      <input
      ...
      />
      <h2 className="px-4 font-semibold text-zinc-600">Sortiranje</h2>
      <select
        value={sortBy}
      ...
      >
        ...
        <option value="totalSpending">Ukupan trošak</option>
      </select>
      <select
        value={ascDsc}
